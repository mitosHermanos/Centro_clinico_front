...
class EditDoctorPassword extends React.Component{
    constructor(props){
        super(props);
    ...
    changePassword(){
        ...
        fetch(`${serviceConfig.baseURL}/doctor/change-password`, requestOptions)
        .then((response) => {
            if (!response.ok) {
                ...
                <Card>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Card.Footer style={{display:"flex", justifyContent:"flex-end"}}>
                            ...
                            <Button variant="danger" size="sm" onClick={() => this.nextPath('/doctorProfile')}>Cancel</Button>
                        </Card.Footer>
                    </Form>
                </Card>
...
export default EditDoctorPassword;