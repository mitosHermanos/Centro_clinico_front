...
class EditDoctorInfo extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            doctor: {
    ...
    handleChange(e) {
        ...
        newDoctor[e.target.id] = e.target.value;
        this.setState({
          doctor: newDoctor
        });
    }
    ...
    render(){
        const {name, surname, phoneNumber, street, streetNumber, city, postcode, country} = this.state.doctor;
        ...
        <Container style={{marginTop:"5rem", width:"50rem"}}>
            <Card>
                ...
                <Card.Footer style={{display:"flex", justifyContent:"flex-end"}}>
                    ...
                    <Button variant="danger" onClick={() => this.nextPath('/doctorProfile') }>Cancel</Button>
                </Card.Footer>
                </Form>
            </Card>
